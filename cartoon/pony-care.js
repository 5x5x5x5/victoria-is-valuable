...
const PonyCare = (() => {
    ...
    const DIALOGUES = {
        idle: [
            "Ooh! I'd love some yummy XML right about now! 🍽️",
            "My classpath feels a teensy bit empty... got any jars? 🫙",
            "Did someone say... dependency injection?! I LOVE that! 💉✨",
            "*blinks big sparkly eyes at you* Hi friend! 👀💖",
            "The server meadow is so pretty today! 🌸",
            "I dreamt of a world with ZERO NullPointerExceptions! 🌈",
            "Is it deploy day yet? Is it? IS IT?! 🎉",
            "I can smell a Spring Bean nearby... smells delicious! 🌱",
            "My hooves are tappy-tap-tapping with excitement! 🐴",
        ],
        hungry: [
            "Pleeeease... just one more <bean> tag? Pretty please? 🥺",
            "My tummy.xml is empty! Feed me! 🍽️",
            "BEEP BOOP: FeedNotFoundException! (That means I'm hungry!) 📢",
            "I'm so hungry I could munch a whole pom.xml! 😋",
            "Ooh is that a Spring config file? *bounces excitedly* 🤤",
        ],
        happy: [
            "BUILD SUCCESSFUL! NEIGH YEAH! 🎊🐴",
            "All tests passing! Best! Day! EVER! 🌟",
            "I could deploy to production TWICE! Watch me go! 🚀🚀",
            "My beans are SO perfectly autowired right now! 💅",
            "Zero exceptions today! I'm on a ROLL! 🎯",
        ],
        sad: [
            "Aww... the deployment didn't work... *sniff* 🥲",
            "I saw some really messy XML today... it was scary... 😢",
            "The Jenkins pipeline is being mean again... 😿",
            "Why can't everything just be Spring Boot? *sigh* 🍃",
            "I feel like a deprecated API... nobody calls me anymore... 📞",
        ],
        sick: [
            "Achoo! NullPointerException... right in my nose! 🤧",
            "*hiccups out a tiny stack trace* Excuse me! 🫣",
            "I think I caught a ClassNotFoundException cold... 🤒",
            "My garbage collector is being lazy today... help! 😵‍💫",
            "The heap... it's getting all wobbly... whoa... 🫠",
        ],
    };
