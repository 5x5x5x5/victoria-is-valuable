...
const Game = (() => {
    ...
    function save() {
        ...
        localStorage.setItem('deployPonySave_cartoon', JSON.stringify(data));
    }

    function load() {
        const raw = localStorage.getItem('deployPonySave_cartoon');
        if (!raw) return false;
        try {
    ...
    function clearSave() {
        localStorage.removeItem('deployPonySave_cartoon');
    }
